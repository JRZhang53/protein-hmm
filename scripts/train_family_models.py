...
from protein_hmm.analysis.family_comparison import cross_family_likelihood_matrix, transition_distance_matrix
...
def main() -> None:
    ...
    ordered_families, transition_distances = transition_distance_matrix(models)
    _, cross_family = cross_family_likelihood_matrix(models, encoded_test)

    metrics = {
        "families": ordered_families,
        "transition_distance_matrix": transition_distances.tolist(),
